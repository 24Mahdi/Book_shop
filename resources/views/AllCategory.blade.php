                    ...
                    <li>
                        <div id="btnorder" style="font-size: 1.5rem;padding-top: 0.8rem; padding-bottom: 0.8rem;"
                            ...
                            <a href="" style="text-decoration: none;">
                                الاقسام<span class="hidden sm:inline"></span>
                            </a>
                        </div>
                    </li>
                </ul>
                ...
                <article class="p-4 lg:p-4 xl:p-6 space-x-4 items-start lg:space-x-4 xl:space-x-6 flex"
                    ...
                    <div class="min-w-0 relative flex-auto">
                        <h2 class="font-semibold text-slate-900 truncate sm:pr-20 dark:text-slate-100"
                            style="font-size: 1.3rem">{{ $category->description }}</h2>
                        <div>
                            <div>
                                <div>
                                    <div
                                        style="position: absolute;
                                        transform: translate(1497%, -42%);
                                        text-align: right;">
                                        <a href="{{ route('categry.edit', ['id' => $category->id]) }}" id="buttonedit"
                                            type="submit"
                                        ...
                                        <form action="{{ route('remove.categry', $category->id) }}" method="POST">
                                            @csrf
                                            @method('delete')
                                            <button type="submit"
                                                onclick="return confirm('هل أنت متأكد من رغبتك في حذف هذا المنتج؟')"
                                                style="font-size: 1.4rem;font-family: auto;color: #ffffff;background: #dc2626;padding: 0.4rem;border-radius: 0.3rem;ma-top: 0.5rem;margin-top: 0.4rem;">حذف</button>
                                        </form>
