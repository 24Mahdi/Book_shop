    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-200 min-h-screen transition-all main">
        ...
        <div class="min-h-screen bg-gray-100 p-0 sm:p-12" style="direction: rtl;">
            <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
                <h1 class="text-2xl font-bold mb-8" style="text-align: center">أضافة كتاب</h1>

                <form method="post" action="{{ route('product.add') }}" enctype="multipart/form-data">
                    @csrf
                    <div class="relative z-0 w-full mb-5">
                        <input style="font-size: 1.3rem;" type="text" name="book_name" placeholder=" " required
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <input style="font-size: 1.3rem;" type="text" name="book_description" placeholder=" "
                            class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <input style="font-size: 1.3rem;" type="text" name="Book_section" placeholder=""
                            class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                        <label for="email" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">عدد
                            صفحات الكتاب
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <input style="font-size: 1.3rem;" type="text" name="Author" placeholder=" "
                            class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <input required style="font-size: 1.3rem;" type="text" name="lang" placeholder=" "
                            class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                        <label for="password" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">للغة
                            الكتاب
                        </label>
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <input style="padding-top: 1rem;font-size: 1.3rem;" type="number" name="price"
                            placeholder=" "
