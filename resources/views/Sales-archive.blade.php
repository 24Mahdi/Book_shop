...
<body class="text-gray-800 font-inter" style="overflow-x: hidden;">
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-200 min-h-screen transition-all main">
        ...
        <div class="bg-white p-8 rounded-md w-full">
            <div class=" flex items-center justify-between pb-6" style="direction: rtl;">
                <div>
                    <h2 class="text-gray-600 font-semibold" style="font-size: 1.4rem;">أرشيف الطلبات</h2>
                    <!-- <span class="text-xs">All products item</span> -->
                </div>
                <div class="flex items-center justify-between">
                    <div class="flex bg-gray-50 items-center p-2 rounded-md" style="background: #d9d9d9;">
                        ...
                        <input class="bg-gray-50 outline-none ml-1 block " type="text" name=""
                            id="" placeholder="بحث..." style="background: #d9d9d9;color: #484646;">
                    </div>
                </div>
            </div>
            <div>
                <div style="class="overflow-x-auto"">
                    <div class="-mx-4 sm:-mx-8 px-4 sm:px-8 py-4 overflow-x-auto">
                        <div class="inline-block min-w-full shadow rounded-lg overflow-hidden">
                            <table class="min-w-full leading-normal" style="direction: ltr;overflow-x: hidden;">
                                <thead>
                                    <tr>
                                            ...
                                            <td class="px-6 py-4 whitespace-nowrap">
                                                <div class="flex items-center">
                                                    <div class="flex-shrink-0 h-10 w-10">
                                                        <img style="height: 4rem;" class="h-10 w-10 "
