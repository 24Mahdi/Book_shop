...
<body class="text-gray-800 font-inter">
    ...
    <div
        ...
        <a href="{{ route('index') }}" class="flex items-center pb-4 border-b border-b-gray-800">
            ...
            <h2 class="font-bold text-3xl">مكتبة <span class="bg-[#16a34a] text-white px-2 rounded-md text-3xl"
                    style="padding-bottom: 0.5rem;padding-top: 0.3rem;padding-right: 0.9rem;padding-left: 0.9rem;">إلكترونية</span>
            </h2>
        </a>
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-200 min-h-screen transition-all main">
            ...
            <ul class="ml-auto flex items-center">
                <li class="mr-1 dropdown">
                    ...
                    <div
                        ...
                        <div class="p-4 border-b border-b-gray-100">
                            <div class="relative w-full" style="direction: rtl;">
                                <input name="book_name" id="search" style="font-size: 1.1rem;font-family: auto;"
                                    type="text"
        ...
        <style>
            ...
            #product {
                background:
                    linear-gradient(to right, rgba(39, 174, 96, 0.2) 50%, transparent 50%),
                    radial-gradient(rgba(33, 145, 80, 0.808) 30%);
        ...
        <div id="responsive-box"
            class="relative z-10 bg-white rounded-xl shadow-xl ring-1 ring-slate-900/5 divide-y divide-slate-100 my-auto xl:mt-18 dark:bg-slate-800 dark:divide-slate-200/5 dark:highlight-white/10">
            <nav class="py-4 px-4 sm:px-6 lg:px-4 xl:px-6 text-sm font-medium">
                <ul class="flex space-x-3">
                    <li>
                        <a href="#">
                            <div id="product" style="font-size: 1.5rem;padding-top: 0.8rem; padding-bottom: 0.8rem;"
                                class="px-3 py-2 rounded-md bg-green-600 text-white cursor-pointer">
                                المنتجات<span class="hidden sm:inline lg:hidden xl:inline"></span></div>
                        </a>
                    </li>
                    <li>
                        <div id="btnorder" style="font-size: 1.5rem;padding-top: 0.8rem; padding-bottom: 0.8rem;"
                            class="px-3 py-2 rounded-md bg-slate-50 cursor-pointer dark:bg-transparent dark:text-slate-300 dark:ring-1 dark:ring-slate-700"
                            onclick="applyEffect()">
                            <a href="" style="text-decoration: none;">
                                الطلبات<span class="hidden sm:inline"></span>
                            </a>
                        </div>
                    </li>
                </ul>
            ...
            @foreach ($products as $product)
                <article class="p-4 lg:p-4 xl:p-6 space-x-4 items-start lg:space-x-4 xl:space-x-6 flex">
                    <img src="{{ asset('public/image/' . $product->image) }}" loading="lazy" decoding="async"
                        alt="{{ $product->book_name }}" width="60vw" height="88vw"
                    ...
                    <div class="min-w-0 relative flex-auto">
                        <h2 class="font-semibold text-slate-900 truncate sm:pr-20 dark:text-slate-100"
                            style="font-size: 1.3rem">{{ $product->book_name }}</h2>
                        <dl style=" position: relative;" class="mt-2 flex flex-wrap text-sm leading-6 font-medium">
                            <div
                                class="block absolute top-0 right-0 sm:flex items-center space-x-1 dark:text-slate-100">
                            </div>
                            ...
                            <div>
                                ...
                                <dd class="flex items-center" style="font-weight: bold;font-size: 1rem;"><svg
                                        width="2" height="2" fill="currentColor"
                                        class="mx-2 text-slate-300" aria-hidden="true">
                                        <circle cx="1" cy="11" r="11"></circle>
                                    </svg>{{ $product->Book_section }}</dd>
                            </div>
                            <div class="flex-none w-full mt-2 font-normal">
                                <dt class="sr-only">Cast</dt>
                                <dd class="text-slate-400" style="font-size: 1rem;font-weight:bolder;">
                            ...
                            <div>
                                <div>
                                    <div>
                                        <div style="position: absolute; transform: translate(-96%, -63%);">
                                            <a href="{{ route('product.edit', ['id' => $product->id]) }}"
                                                id="buttonedit" type="submit"
                                                style="font-size: 1.7rem; font-weight: 450; font-family: auto;color: #ffffff;background: #1fbd59;padding: 0.5rem;border-radius: 0.3rem;">
                                                تعديل
                                            </a>
                                            <form action="{{ route('products.remove', ['id' => $product->id]) }}"
                                                method="POST">
                                                @csrf
                                                @method('delete')
                                                <button type="submit"
                                                    onclick="return confirm('هل أنت متأكد من رغبتك في حذف هذا المنتج؟')"
                                                    style="font-size: 1.7rem;font-family: auto;color: #ffffff;background: #dc2626;padding: 0.5rem;border-radius: 0.3rem;ma-top: 0.5rem;margin-top: 0.4rem;">حذف</button>
                                            </form>
                                        </div>
                                    </div>
                                </div>
