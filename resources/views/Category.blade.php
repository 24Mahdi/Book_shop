    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-200 min-h-screen transition-all main">
        ...
        <div class="flex justify-center my-2 mx-4 md:mx-0" style="    padding-bottom: 2rem;">
            <form class="w-full max-w-xl bg-white rounded-lg shadow-md p-6" method="post"
                action="{{ route('categry.add') }}" enctype="multipart/form-data">
                @csrf
                <div class="flex flex-wrap -mx-3 mb-6">
                    <div class="w-full md:w-full px-3 mb-6">
                        ...
                        <input name="description" style="text-align: right;font-size: 1.2rem;"
                    ...
                    <div class="w-full md:w-full px-3 mb-6">
                        <button
                            class="appearance-none block w-full bg-green-600 text-gray-100 font-bold border border-gray-200 rounded-lg py-3 px-3 leading-tight hover:bg-green-500 focus:outline-none focus:bg-green focus:border-gray-500">أنشاء</button>
                    </div>
