...
<body class="text-gray-800 font-inter" style="overflow-x: hidden;">
    ...
    <div class="fixed left-0 top-0 w-64 h-full bg-[#f2fcf6] p-4 z-50 sidebar-menu transition-transform">
        <a href="{{ route('index') }}" class="flex items-center pb-4 border-b border-b-gray-800">
            ...
            <h2 class="font-bold text-3xl"style="direction: ltr;">مكتبة <span
                    class="bg-[#16a34a] text-white px-2 rounded-md text-3xl"
                    style="padding-bottom: 0.5rem;direction: ltr;">إلكترونية</span>
            </h2>
        </a>
    ...
    <main class="w-full md:w-[calc(100%-256px)] md:ml-64 bg-gray-200 min-h-screen transition-all main">
        ...
        <style>
            ...
            .iframe-container {
                ...
                /* عرض العنصر */
                margin: 100px auto 0;
                /* محاذاة العنصر في وسط الصفحة وترك مسافة من فوقه */
                overflow: hidden;
                /* position: relative; */
            }
            ...
            .iframe-container iframe {
                ...
                /* للمتصفحات التي تدعم هذه الخاصية */
        ...
        <div class="min-h-screen bg-gray-100 p-0 sm:p-12" style="direction: rtl;">
            <div class="mx-auto max-w-md px-6 py-12 bg-white border-0 shadow-lg sm:rounded-3xl">
                <h1 class="text-2xl font-bold mb-8" style="text-align: center"> تحديث المعلومات</h1>
                <form method="post" action="{{ route('product.update', ['id' => $product->id]) }}"
                    enctype="multipart/form-data">
                    @method('put')
                    @csrf
                    <div class="relative z-0 w-full mb-5">
                        <input value="{{ $product->book_name }}" style="font-size: 1.3rem;" type="text"
                            name="book_name" placeholder=" " required
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <input value="{{ $product->book_description }}" style="font-size: 1.3rem;" type="text"
                            name="book_description" placeholder=" "
                            class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                        <label for="email" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">وصف
                            الكتاب</label>
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <input value="{{ $product->Book_section }}" style="font-size: 1.3rem;" type="text"
                            name="Book_section" placeholder=""
                            class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                        <label for="email" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">قسم
                            الكتاب
                        </label>
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <input value="{{ $product->Author }}" style="font-size: 1.3rem;" type="text"
                            name="Author" placeholder=" "
                            class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                        <label for="password" class="absolute duration-300 top-3 -z-1 origin-0 text-gray-500">أسم
                            المؤلف</label>
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <input value="{{ $product->lang }}" style="font-size: 1.3rem;" type="text"
                            name="lang" placeholder=" "
                            class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                    ...
                    <div class="relative z-0 w-full mb-5">
                        <input value="{{ $product->price }}" style="padding-top: 1rem;font-size: 1.3rem;"
                            type="number" name="price" placeholder=" "
                            class="pt-3 pb-2 pl-5 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200" />
                        <div class="absolute top-0 left-0 mt-3 ml-1 text-gray-400">$</div>
                        <label for="Author_name"
                            class="absolute duration-300 top-3 left-5 -z-1 origin-0 text-gray-500">السعر</label>
                        @error('price')
                            <span class="text-danger">{{ $message }}</span>
                        @enderror
                    </div>
                    @if ($product->image > 0)
                        <img style="height: 30Vh !important;" src="{{ asset('public/image/' . $product->image) }}"
                            height="100vh" alt="">
                    @else
                        <img style="height: 30Vh !important;" src="{{ asset('public/image/product/default.jpg') }}"
                            height="100vh" alt="">
                    @endif
                    <div class="relative z-0 w-full mb-5">
                        <label class="hover:bg-green-600 absolute duration-300 top-3 -z-1 origin-0 text-gray-500"
                            style="z-index: 11; background: #b6c0ba; color: #ffffff; padding: 0.7rem; width: 100%; border-radius: 0.3rem; font-size: 1.3rem;    cursor: pointer;">
                            <i class="fa-solid fa-upload"
                                style="    color: #555555;padding-left: 0.5rem;font-size: 1.7rem;"></i> الصورة
                        </label>
                        <input style="width: 100%;text-align: center;font-size: 1.7rem;" type="file"
                            name="image" placeholder=" "
                            class="pt-3 pb-2 block w-full px-0 mt-0 bg-transparent border-0 border-b-2 appearance-none focus:outline-none focus:ring-0 focus:border-black border-gray-200"
                            data-multiple-caption="{count} ملفات محددة" accept="image/*" />
